...
- `data/gender_inequality_quadrant_data.csv`: clean figure-ready data extracted from `D:\ws\Fig4.csv`.
...
- `data/lorenz_curve_points.csv`: city-level Lorenz curve coordinates for nighttime female and male activity.
